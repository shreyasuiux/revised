...
export const SearchModal: React.FC<SearchModalProps> = ({ isOpen, onClose, onNavigate }) => {
  ...
  const searchData: SearchResult[] = [
    ...
    { 
      ...
      category: "Pages",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-home'))
    },
    ...
    { 
      ...
      category: "Services",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-service', { detail: 'Cloud Practice' }))
    },
    { 
      title: "Digital & Product Engineering", 
      description: "Custom software development and product engineering", 
      category: "Services",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-service', { detail: 'Digital & Product Engineering' }))
    },
    { 
      title: "Big Data", 
      description: "Data analytics, warehousing, and big data solutions", 
      category: "Services",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-service', { detail: 'Big Data' }))
    },
    { 
      title: "App Modernization", 
      description: "Application modernization and cloud migration", 
      category: "Services",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-service', { detail: 'App Modernization' }))
    },
    { 
      title: "Security", 
      description: "Cybersecurity and compliance solutions", 
      category: "Services",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-service', { detail: 'Security' }))
    },
    { 
      title: "Database Management", 
      description: "Database design, optimization, and management", 
      category: "Services",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-service', { detail: 'Database Management' }))
    },
    { 
      title: "ERP Testing & Automation", 
      description: "Enterprise resource planning testing services", 
      category: "Services",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-service', { detail: 'ERP Testing & Automation' }))
    },
    ...
    { 
      ...
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-ai', { detail: 'BFSI Agents' }))
    },
    { 
      title: "Brand Management Agents", 
      description: "AI-powered brand and marketing automation agents", 
      category: "AI Solutions",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-ai', { detail: 'Brand Management Agents' }))
    },
    ...
    { 
      ...
      category: "Products",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-product', { detail: 'Agent Studio' }))
    },
    { 
      title: "Atlas API Manager", 
      description: "Comprehensive API management platform", 
      category: "Products",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-product', { detail: 'Atlas API Manager' }))
    },
    { 
      title: "Ottohm Video", 
      description: "Enterprise video collaboration platform", 
      category: "Products",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-product', { detail: 'Ottohm Video' }))
    },
    { 
      title: "ITSM Ticketing", 
      description: "IT service management and ticketing system", 
      category: "Products",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-product', { detail: 'ITSM Ticketing' }))
    },
    { 
      title: "AIOps", 
      description: "AI-powered IT operations and monitoring", 
      category: "Products",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-product', { detail: 'AIOps' }))
    },
    { 
      title: "Smart Contracts", 
      description: "Blockchain-based smart contract solutions", 
      category: "Products",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-product', { detail: 'Smart Contracts' }))
    },
    ...
    { 
      ...
      category: "Who We Are",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-whoweare', { detail: 'Our Team' }))
    },
    { 
      title: "About Us", 
      description: "Our story, mission, and values", 
      category: "Who We Are",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-whoweare', { detail: 'About Us' }))
    },
    { 
      title: "Partners", 
      description: "Our technology and strategic partners", 
      category: "Who We Are",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-whoweare', { detail: 'Partners' }))
    },
    { 
      title: "Careers", 
      description: "Join our team and grow with us", 
      category: "Who We Are",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-whoweare', { detail: 'Careers' }))
    },
    { 
      title: "News & Updates", 
      description: "Latest company news and announcements", 
      category: "Who We Are",
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-whoweare', { detail: 'News' }))
    },
    ...
    { 
      ...
      navigationHandler: () => window.dispatchEvent(new CustomEvent('navigate-casestudies'))
    },
  ];
