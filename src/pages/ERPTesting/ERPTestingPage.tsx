...
import { ERPTestingPage as ERPTestingPageComponent } from '@/app/components/ERPTestingPage';

export default function ERPTestingPage() {
  ...
  const handleGrowWithUsClick = (section: string) => {
    navigate('/company/careers');
    window.scrollTo({ top: 0, behavior: 'smooth' });
  };

  return (
    <ERPTestingPageComponent
      onClose={handleClose}
