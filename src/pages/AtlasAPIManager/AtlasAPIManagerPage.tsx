...
import { AtlasAPIManagerPage as AtlasAPIManagerPageComponent } from '@/app/components/AtlasAPIManagerPage';

export default function AtlasAPIManagerPage() {
