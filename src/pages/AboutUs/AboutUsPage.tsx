...
import AboutUsPageComponent from '@/app/components/AboutUsPage';
...
export default function AboutUsPage() {
  ...
  return (
    <AboutUsPageComponent
      ...
      onAIClick={(aiPageTitle: string) => {
        // TODO: Map AI page titles to routes if needed
        navigation.onAIClick();
      }}
      ...
      onCareersClick={navigation.onCareersClick}
    />
  );
}
